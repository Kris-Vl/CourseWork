...
public class DeleteController {
    ...
    void Delete(ActionEvent event) throws SQLException, IOException {
        ...
        if (DBHandler.deleteCoffee(coffee))
            controller.goTo(event, stage, scene,"/org.coffee/successDelete.fxml");
        else controller.goTo(event, stage, scene,"/org.coffee/failedDelete.fxml");
    }
}
